...
(function($) {
	...
	var right_answers = 0;
		...
		if (right_answers == 0) {
		    $("#quiz-reply").html("<h3>Sorry, none correct.</h3>");
		    console.log(right_answers);
		}
		
		if (right_answers ==1) {
		    $("#quiz-reply").html("<h3>Keep Trying</h3>");
		    console.log(right_answers);
		}
		
		if (right_answers >=5) {
		    $("#quiz-reply").html("<h3>Not Bad</h3>")
		}
		
		if (right_answers >=7) {
		    $("#quiz-reply").html("<h3>Very Good</h3>")
		}
		
		if (right_answers >=9) {
		    $("#quiz-reply").html("<h3>Amazing!</h3>")
		}
